...
public class ModClassify {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//点击编辑按钮
		wd.findElement(By.xpath("html/body/div[1]/div[2]/div[2]/div/div/table/tbody/tr[5]/td[3]/a[1]/i")).click();
		//输入新的名称“营养度”
		wd.findElement(By.name("mclassify.mclassifyName")).clear();
		Thread.sleep(2000);
		wd.findElement(By.name("mclassify.mclassifyName")).sendKeys("营养度");
		//点击提交
		wd.findElement(By.xpath("html/body/div[1]/div[2]/div[2]/div/form/fieldset/div[2]/input")).click();
