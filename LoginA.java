...
//        capabilities.setCapability("noReset", true);
    ...
    public void registerTest(){
        ...
        ta.press(e11);
        //点击“登录”按钮
        AndroidElement e12 = driver.findElementById("main_Tv_login");
        ta.press(e12);
        //用户名        driver.findElementById("login_verify_Et_username").sendKeys("1443974302@qq.com");
        //密码
        driver.findElementById("login_verify_Et_password").sendKeys("123456");
        //登录
        AndroidElement e13 = driver.findElementById("login_verify_Btn_login");
        ta.press(e13);
